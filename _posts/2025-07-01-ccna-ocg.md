...
{% include elements/figure.html image="/assets/blog/2025-07-01-ccna-ocg/ccna-certificate.jpg" alt="Cisco CCNA certificate earned by Dimitriy Leontev" loading="eager" caption="This was the destination. The blueprint in this post was the path." %}
...
{% include elements/figure.html image="/assets/blog/2025-07-01-ccna-ocg/odom-cert-guide.jpg" alt="Wendell Odom CCNA 200-301 Official Cert Guide volumes" caption="The cornerstone of my theoretical studies. The level of detail in Odom's guide is unmatched." %}
...
{% include elements/figure.html image="/assets/blog/2025-07-01-ccna-ocg/jeremys-it-lab.png" alt="Jeremy’s IT Lab CCNA video course" caption="Jeremy's IT Lab offers a comprehensive video course covering all CCNA exam topics." %}
...
{% include elements/figure.html image="/assets/blog/2025-07-01-ccna-ocg/keith-barker.png" alt="Keith Barker networking training channel" caption="Whenever I was stuck, Keith Barker's energetic explanations helped the concepts click." %}
...
{% include elements/figure.html image="/assets/blog/2025-07-01-ccna-ocg/kevin-wallace.png" alt="Kevin Wallace CCNA training course" caption="A great resource for getting a high-level overview or a final review." %}
...
{% include elements/figure.html image="/assets/blog/2025-07-01-ccna-ocg/packet-tracer.png" alt="Cisco Packet Tracer network simulation workspace" caption="I spent countless hours in Packet Tracer. It's an essential (and free!) learning tool." %}
...
{% include elements/figure.html image="/assets/blog/2025-07-01-ccna-ocg/cml-dashboard.png" alt="Cisco Modeling Labs dashboard" caption="Cisco Modeling Labs (CML) offers a more realistic simulation, perfect for validating concepts learned in Packet Tracer." %}
...
{% include elements/figure.html image="/assets/blog/2025-07-01-ccna-ocg/boson-exsim.png" alt="Boson ExSim CCNA practice exam interface" caption="Boson ExSim was the closest thing to the real exam. The detailed explanations are where the real learning happens." %}
...
{% include elements/figure.html image="/assets/blog/2025-07-01-ccna-ocg/quizzes-composite.png" alt="Networking quiz resources from Keith Barker and CBT Nuggets" caption="I used playlists from Keith Barker and CBT Nuggets for regular knowledge checks throughout my studies." %}
